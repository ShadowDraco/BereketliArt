...
export const worldLeaders = [
  ...
  },*/
  {
    ...
    title: 'Forever Free',
    name: 'forever-free',
    description: 'A thick chain blown to pieces by Abraham Lincoln',
  },
  {
    image: martin,
    title: 'MLK',
    name: 'carnival-curtain',
    description: 'A dream of human dignity, Truth and equality.',
  },
  {
    image: reagan,
    title: 'Reagan',
    name: 'reagan',
    description: "Metin's portrait of the smiling and confident President Reagan.",
  },
];
...
export const charities = [
  {
    ...
    name: 'diversity2003',
    description: "Metin donates to MMPA's Scholarship Fund",
  },
  {
    image: marjcohen,
    title: 'Israel Cancer Research Fund',
    name: 'icrf',
    description: 'Metin, with Marjorie Cohen, ICRF Executive Director.',
  },
  {
    image: mcdonne,
...
export const press = [
  ...
  {
    image: potionMagazine,
    title: 'Magazine Cover-Potion',
    name: 'magazine-potion',
    description: 'Metin\'s "Potion" is considered for the cover of Positive Magazine',
  },
  {
    image: triumphAwards,
  ...
  },
  {
    ...
    name: 'best-buddies',
    description:
      'Metin receives a letter of appreciation from Founder of Best Buddies International!',
  },
  {
